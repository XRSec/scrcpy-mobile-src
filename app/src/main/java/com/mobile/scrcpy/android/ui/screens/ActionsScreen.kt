...
fun ActionsScreen(viewModel: MainViewModel) {
    ...
    val txtNoActions = rememberText(BilingualTexts.ACTIONS_NO_ACTIONS.chinese, BilingualTexts.ACTIONS_NO_ACTIONS.english)
...
fun EmptyActionsView() {
    val txtNoActions = rememberText(BilingualTexts.ACTIONS_NO_ACTIONS.chinese, BilingualTexts.ACTIONS_NO_ACTIONS.english)
    val txtEmptyHint = rememberText(BilingualTexts.ACTIONS_EMPTY_HINT.chinese, BilingualTexts.ACTIONS_EMPTY_HINT.english)
