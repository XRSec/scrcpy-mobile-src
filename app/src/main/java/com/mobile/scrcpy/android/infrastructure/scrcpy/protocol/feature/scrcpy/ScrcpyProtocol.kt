...
object ScrcpyProtocol {
     ...
     * 将 long 值写入字节数组（大端序）
     */
    fun writeLong(buffer: ByteArray, offset: Int, value: Long) {
     ...
     * 将 short 值写入字节数组（大端序）
     */
    fun writeShort(buffer: ByteArray, offset: Int, value: Int) {
     ...
     * 从字节数组读取 int 值（大端序）
     */
    fun bytesToInt(buffer: ByteArray, offset: Int): Int {
