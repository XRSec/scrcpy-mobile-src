...
import com.mobile.scrcpy.android.core.data.model.AppLanguage
...
fun LanguageScreen(
    ...
    val txtTitle = rememberText(BilingualTexts.LANGUAGE_TITLE.chinese, BilingualTexts.LANGUAGE_TITLE.english)
    val txtSectionTitle = rememberText(BilingualTexts.LANGUAGE_SECTION_TITLE.chinese, BilingualTexts.LANGUAGE_SECTION_TITLE.english)
    val txtAuto = rememberText(BilingualTexts.LANGUAGE_AUTO.chinese, BilingualTexts.LANGUAGE_AUTO.english)
    val txtChinese = rememberText(BilingualTexts.LANGUAGE_CHINESE.chinese, BilingualTexts.LANGUAGE_CHINESE.english)
    val txtEnglish = rememberText(BilingualTexts.LANGUAGE_ENGLISH.chinese, BilingualTexts.LANGUAGE_ENGLISH.english)
