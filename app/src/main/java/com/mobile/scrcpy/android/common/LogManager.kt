...
object LogManager {
    ...
    private fun initLogFile() {
        try {
            ...
            i(LogTags.LOG_MANAGER, "${BilingualTexts.LOG_SYSTEM_INIT_SUCCESS.get()}: ${logFile?.absolutePath}")
        } catch (e: Exception) {
            Log.e(LogTags.LOG_MANAGER, BilingualTexts.LOG_INIT_FILE_FAILED.get(), e)
        }
    }
    ...
    private fun closeLogFile() {
        try {
            ...
            Log.e(LogTags.LOG_MANAGER, BilingualTexts.LOG_CLOSE_FILE_FAILED.get(), e)
        }
    }
    ...
    private fun writeLog(level: String, tag: String, message: String, throwable: Throwable? = null) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                Log.e(LogTags.LOG_MANAGER, BilingualTexts.LOG_WRITE_FAILED.get(), e)
            }
        }
    }
    ...
    fun deleteLogFile(file: File): Boolean {
        return try {
            ...
            Log.e(LogTags.LOG_MANAGER, BilingualTexts.LOG_DELETE_FILE_FAILED.get(), e)
            false
        }
    }
    ...
    fun readLogFile(file: File): String {
        return try {
            ...
            Log.e(LogTags.LOG_MANAGER, BilingualTexts.LOG_READ_FILE_FAILED.get(), e)
            "${BilingualTexts.LOG_READ_FILE_ERROR.get()}: ${e.message}"
        }
    }
    ...
    fun writeRawLog(level: String, tag: String, message: String) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                Log.e(LogTags.LOG_MANAGER, BilingualTexts.LOG_WRITE_RAW_FAILED.get(), e)
            }
        }
    }
